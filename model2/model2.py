...
def plot_results(history):
    ...
    plt.subplot(1, 2, 1)
    plt.suptitle('Optimizer : Adam | Model 2', fontsize=10)
...
def show_confusion_matrix(y_test, y_pred, label_map):
    ...
    plot_confusion_matrix(cnf_matrix, classes=label_map, normalize=True, title='Confusion matrix, with normalization | Model 2')
...
def train(model, X_train, y_train, X_test, y_test):
    ...
    model.save_weights("model2_weigths.h5")
...
model2 = model2(num_class)
train(model2, X_train, y_train, X_test, y_test)