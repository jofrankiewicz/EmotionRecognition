...
categorical_accuracy = d['categorical_accuracy']
loss = d['loss']
val_categorical_accuracy = d['val_categorical_accuracy']
val_loss = d['val_loss']
...
y_test = pd.read_csv('test_vector_1.csv')
y_predicted = pd.read_csv('predicted_vector_1.csv')
