...
y_test = pd.read_csv('test_vector_4.csv')
y_predicted = pd.read_csv('predicted_vector_4.csv')
...
def show_confusion_matrix(y_test, y_pred, label_map):
    ...
    plot_confusion_matrix(cnf_matrix, classes=label_map, normalize=True, title='Confusion matrix, with normalization | Model 4')
    plt.show()
